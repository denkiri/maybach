...
class RemotasksPage extends StatefulWidget {
  const RemotasksPage({super.key});

  @override
  State<RemotasksPage> createState() => _RemotasksPageState();
}

class _RemotasksPageState extends State<RemotasksPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadRemotasksPackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/remotasks_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
class UpdateRemotasksPackagePage extends StatefulWidget {
  const UpdateRemotasksPackagePage({super.key});

  @override
  State<UpdateRemotasksPackagePage> createState() => _UpdateRemotasksPackagePageState();
}

class _UpdateRemotasksPackagePageState extends State<UpdateRemotasksPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadRemotasksPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Remotasks Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
