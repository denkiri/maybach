...
class _VerificationPageState extends State<VerificationPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadVerificationPackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/verification_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
class UpdateVerificationPackagePage extends StatefulWidget {
  const UpdateVerificationPackagePage({super.key});

  @override
  State<UpdateVerificationPackagePage> createState() => _UpdateVerificationPackagePageState();
}

class _UpdateVerificationPackagePageState extends State<UpdateVerificationPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadVerificationPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Verification Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
