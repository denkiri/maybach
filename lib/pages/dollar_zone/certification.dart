...
class _CertificationPageState extends State<CertificationPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadCertificationPackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/certification_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
class UpdateCertificationPackagePage extends StatefulWidget {
  const UpdateCertificationPackagePage({super.key});

  @override
  State<UpdateCertificationPackagePage> createState() => _UpdateCertificationPackagePageState();
}

class _UpdateCertificationPackagePageState extends State<UpdateCertificationPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadCertificationPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Certification Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
