...
class PlatinumPackagePage extends StatefulWidget {
  const PlatinumPackagePage({super.key});
...
class _PlatinumPackagePageState extends State<PlatinumPackagePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadPlatinumPackage());
  }
...
class UpdatePlatinumPackagePage extends StatefulWidget {
  const UpdatePlatinumPackagePage({super.key});

  @override
  State<UpdatePlatinumPackagePage> createState() => _UpdatePlatinumPackagePageState();
}

class _UpdatePlatinumPackagePageState extends State<UpdatePlatinumPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadPlatinumPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Platinum Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
