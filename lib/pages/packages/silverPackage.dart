...
class SilverPackagePage extends StatefulWidget {
  const SilverPackagePage({super.key});

  @override
  State<SilverPackagePage> createState() => _SilverPackagePageState();
}

class _SilverPackagePageState extends State<SilverPackagePage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadSilverPackage());
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                // In the SilverPackagePage's build method, update just the ElevatedButton part:
                ElevatedButton(
...
class UpdateSilverPackagePage extends StatefulWidget {
  const UpdateSilverPackagePage({super.key});

  @override
  State<UpdateSilverPackagePage> createState() => _UpdateSilverPackagePageState();
}

class _UpdateSilverPackagePageState extends State<UpdateSilverPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadSilverPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Silver Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            buildField("Commission Rate", commissionController,
                isNumeric: true),
            Offstage(
