...
import 'package:flutter_projects/pages/dashboard/widgets/drawer/adminDrawer.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget _getPage() {
    switch (_currentRoute) {
      case '/admin': return const AdminDashboardPage();
      case '/deposit': return const DepositPage();
      case '/silver-package': return const UpdateSilverPackagePage();
      case '/platinum-package': return const UpdatePlatinumPackagePage();
      case '/gold-package': return const UpdateGoldPackagePage();
      case '/notification': return const NotificationsPage();
