...
class UpdateProBonusPackagePage extends StatefulWidget {
  const UpdateProBonusPackagePage({super.key});

  @override
  State<UpdateProBonusPackagePage> createState() => _UpdateProBonusPackagePageState();
}

class _UpdateProBonusPackagePageState extends State<UpdateProBonusPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadProBonusPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Pro Bonus Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
