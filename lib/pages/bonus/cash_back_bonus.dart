...
class CashBackBonusPage extends StatefulWidget {
  const CashBackBonusPage({super.key});

  @override
  State<CashBackBonusPage> createState() => _CashBackBonusPageState();
}

class _CashBackBonusPageState extends State<CashBackBonusPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadCashBackPackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/cash_back_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
class UpdateCashBackBonusPackagePage extends StatefulWidget {
  const UpdateCashBackBonusPackagePage({super.key});

  @override
  State<UpdateCashBackBonusPackagePage> createState() => _UpdateCashBackBonusPackagePageState();
}

class _UpdateCashBackBonusPackagePageState extends State<UpdateCashBackBonusPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadCashBackPackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Cash Back Bonus Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
