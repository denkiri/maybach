...
class _WelcomeBonusPageState extends State<WelcomeBonusPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadWelcomePackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/welcome_bonus_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
class UpdateWelcomeBonusPackagePage extends StatefulWidget {
  const UpdateWelcomeBonusPackagePage({super.key});

  @override
  State<UpdateWelcomeBonusPackagePage> createState() => _UpdateWelcomeBonusPackagePageState();
}

class _UpdateWelcomeBonusPackagePageState extends State<UpdateWelcomeBonusPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadWelcomePackage();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Welcome Bonus Package", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
