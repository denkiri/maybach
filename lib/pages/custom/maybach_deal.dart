...
class MaybachDealPage extends StatefulWidget {
  const MaybachDealPage({super.key});

  @override
  State<MaybachDealPage> createState() => _MaybachDealPageState();
}

class _MaybachDealPageState extends State<MaybachDealPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadMayBachPackage());
  }
...
class UpdateMaybachDealPackagePage extends StatefulWidget {
  const UpdateMaybachDealPackagePage({super.key});

  @override
  State<UpdateMaybachDealPackagePage> createState() => _UpdateMaybachDealPackagePageState();
}

class _UpdateMaybachDealPackagePageState extends State<UpdateMaybachDealPackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadMayBachPackage();
  }
