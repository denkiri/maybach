...
class WhatsupLinkagePage extends StatefulWidget {
  const WhatsupLinkagePage({super.key});

  @override
  State<WhatsupLinkagePage> createState() => _WhatsupLinkagePageState();
}

class _WhatsupLinkagePageState extends State<WhatsupLinkagePage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PackageViewModel>(context, listen: false).loadWhatsupLinkagePackage());
  }
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/whatsup_banner.png',
                        width: 340,
                        height: 340,
                        fit: BoxFit.fill,
                      ),
...
child: Text(
  "Easily link your WhatsApp number to your Maybach account for fast and effortless withdrawals. This secure setup gives you instant access to your funds wherever you are. Enjoy smooth, secure, and speedy transactions with just a tap — anytime, anywhere.",
...
class UpdateWhatsupLinkagePackagePage extends StatefulWidget {
  const UpdateWhatsupLinkagePackagePage({super.key});

  @override
  State<UpdateWhatsupLinkagePackagePage> createState() => _UpdateWhatsupLinkagePackagePageState();
}

class _UpdateWhatsupLinkagePackagePageState extends State<UpdateWhatsupLinkagePackagePage> {
  ...
  void initState() {
    ...
    packageViewModel.loadWhatsupLinkagePackage();
  }
